        ...
        <div className="relative z-10 overflow-hidden flex justify-center items-center w-screen h-screen bg-[var(--lightLemon)]">
            ...
            <form action="" className="flex flex-col p-3 bg-white rounded-3xl gap-4 md:grid md:grid-cols-2">
                ...
                <div className="relative z-1 flex flex-col text-center w-[70%]">
                    <b className="text-[var(--lightGray)]">Compete and climb the leaderboard</b>
                    <small className="text-[#efede693]">Earn points, unlock badges, and beat your friends!</small>
                </div>
                </motion.div>
                <div className="flex flex-col items-center gap-3 md:items-start">
                    <b className="text-[var(--baseColor)] text-xl text-extrabold mt-4 md:text-2xl">BrainFuel</b>
                    <small className="text-[var(--baseColor)] font-bold">login to your account</small>
                    <div className="flex md:flex-col justify-center items-center gap-5 w-full">
                        <span className="md:w-full flex cursor-pointer justify-center items-center bg-[var(--lightGray)] px-5 py-3 rounded-2xl gap-2"><img src="/google.svg" alt="" className="w-6 h-6" /><small className="">{window.innerWidth > 768 ? "Login with Google" : "Google"}</small></span>
                        <span className="md:w-full flex cursor-pointer justify-center items-center bg-[var(--lightGray)] px-5 py-3 rounded-2xl gap-2"><img src="/facebook.svg" alt="" className="w-6 h-6" /><small className="">{window.innerWidth > 768 ? "Login with Facebook" : "Facebook"}</small></span>
                    </div>
                    <b 
                    className="
                    w-[100%]
